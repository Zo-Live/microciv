...
DEFAULT_SEARCH_BEAM_WIDTH = 2
DEFAULT_SEARCH_CANDIDATE_LIMIT = 8

BUILDING_LIMIT_PER_CITY = 8
FOOD_CONSUMPTION_PER_CITY = 4
RIVER_ROAD_WOOD_COST = 15
RIVER_ROAD_ORE_COST = 10
...
SCORE_RIVER_ACCESS_BASE = 20
SCORE_RIVER_ACCESS_DECAY = 6
SCORE_RIVER_ACCESS_FLOOR = 2
SCORE_CITY_COMPOSITION_CONNECTED_MIN = 6
SCORE_CITY_COMPOSITION_PER_CITY = 12
SCORE_CITY_COMPOSITION_TARGET_RATIO = 0.45
SCORE_CITY_COMPOSITION_TOLERANCE = 0.20
SCORE_RESOURCE_RING_TILE_WEIGHT = 5
...
SCORE_BUILDING_WEIGHT = 14
SCORE_TECH_WEIGHT = 120
SCORE_STARVING_NETWORK_PENALTY = 140
SCORE_FRAGMENTED_NETWORK_PENALTY = 16
SCORE_ISOLATED_CITY_PENALTY = 12
...
BUILDING_MISMATCH_THRESHOLDS = MappingProxyType(
    {
        ResourceType.FOOD: 160,
        ResourceType.WOOD: 80,
        ResourceType.ORE: 80,
        ResourceType.SCIENCE: 120,
    }
)

BUILDING_MISMATCH_STEPS = MappingProxyType(
    {
        ResourceType.FOOD: 80,
        ResourceType.WOOD: 40,
        ResourceType.ORE: 40,
        ResourceType.SCIENCE: 60,
    }
)

BUILDING_MISMATCH_CAPS = MappingProxyType(
    {
        ResourceType.FOOD: 12,
        ResourceType.WOOD: 18,
        ResourceType.ORE: 18,
        ResourceType.SCIENCE: 18,
    }
)
